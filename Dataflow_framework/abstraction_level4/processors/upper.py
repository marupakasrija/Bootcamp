# This is abstraction-level-4/processors/upper.py
...
def to_uppercase(line: str) -> str:
    ...
    """
    # print(f"DEBUG: Applying to_uppercase to '{line.strip()}'", file=sys.stderr) # Optional debug print
    return line.strip().upper()

# Could add more uppercase-related processor functions here.
