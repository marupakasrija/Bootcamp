# This is abstraction-level-7/dashboard/app.py
...
# Need to go up two levels to abstraction-level-7, then into types
from ..types import ObservabilityData, ProcessorMetrics, ErrorData, LineTrace
...
app = FastAPI(
    title="Abstraction Level 7 Dashboard API",
    description="API for monitoring the State Transition Engine.",
    version="0.7.0",
)
...
@app.get("/")
async def read_root():
    return {"message": "Abstraction Level 7 Dashboard API is running. Visit /docs for API documentation."}
